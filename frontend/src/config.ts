...
const DEFAULT_API_BASE_PORT_AUTH =
  import.meta.env.VITE_API_BASE_PORT ?? "8005";

const DEFAULT_API_BASE_PORT_ADMIN =
  import.meta.env.VITE_API_BASE_PORT_ADMIN ?? "8000";

const DEFAULT_API_BASE_PORT_APPRENTI =
  import.meta.env.VITE_API_BASE_PORT_APPRENTI ?? "8001";

const DEFAULT_API_BASE_PORT_ENTREPRISE =
  import.meta.env.VITE_API_BASE_PORT_ENTREPRISE ?? "8008";

const DEFAULT_API_BASE_PORT_JURY =
  import.meta.env.VITE_API_BASE_PORT_JURY ?? "8010";
...
export const ENTREPRISE_API_URL = `${DEFAULT_API_BASE_URL}:${DEFAULT_API_BASE_PORT_ENTREPRISE}/entreprise`;
export const JURY_API_URL = `${DEFAULT_API_BASE_URL}:${DEFAULT_API_BASE_PORT_JURY}/jury`;
